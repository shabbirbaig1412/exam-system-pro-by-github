...
class ESP_ClassSummary {

    public function generate(int $exam_id): array {

        return ESP_StatisticsEngine::classSummary($exam_id);
    ...
    public function render(int $exam_id): void {
        ...
        $statistics = (new ESP_StatisticsEngine())->calculate($results);

        ESP_View::render('admin/class-summary', [
            'exam' => $exam,
            'exam_id' => $exam_id,
            'results' => $results,
